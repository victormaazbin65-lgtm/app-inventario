(function (global) {
    ...
    function refrescar(){
        ...
        asegurarOrdenCompra();actualizarOrdenCompra();asegurarCierreDiario();renderCierre();asegurarEtiquetas();actualizarEtiquetas();asegurarPanelAuditoria();
    }

    function init(){inyectarEstilos();instalarCapturaErrores();instalarReservaProductos();instalarClienteSeguro();instalarAuditoriaOperaciones();asegurarOrdenCompra();asegurarCierreDiario();asegurarEtiquetas();asegurarPanelAuditoria();setInterval(refrescar,6000);document.addEventListener('focusout',()=>setTimeout(refrescar,150));refrescar();}
